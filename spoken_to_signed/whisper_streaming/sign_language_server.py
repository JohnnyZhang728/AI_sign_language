...
from pose2json import pose_to_json


lexicon_path = "/Users/zeyuzhang/TAMU/sign_language/sign_language_procesing/text_to_gloss_pose/assets/dummy_lexicon"

# Usage: python sign_language_server.py --warmup-file samples_jfk.wav --lan en --backend openai-api
...
#            print("received audio:",len(raw_bytes), "bytes", raw_bytes[:10])
    ...
    def send_result(self, o):
        ...
        if msg is not None:
            ...
            pose_filename = f"pose_{self.counter}.pose"
            ...
            try:
                ...
                json_pose = pose_to_json(output_pose_path)
                print("JSON generated.")
                self.socket.sendall(json_pose.encode('utf-8'))  # Send to UE
                print("Send to UE")
    ...
    def process(self):
        ...
        start_time = time.time()
        self.start_time = time.time()  # Recording start time
