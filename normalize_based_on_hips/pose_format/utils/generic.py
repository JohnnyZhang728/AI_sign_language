...
def pose_hips(pose_header: PoseHeader):
    if pose_header.components[0].name == "POSE_LANDMARKS":
        # print("POSE_LANDMARKS")
        return ("POSE_LANDMARKS", "RIGHT_HIP"), ("POSE_LANDMARKS", "LEFT_HIP")

    if pose_header.components[0].name == "BODY_135":
        # print("BODY_135")
        return ("BODY_135", "RHip"), ("BODY_135", "LHip")

    if pose_header.components[0].name == "pose_keypoints_2d":
        # print("pose_keypoints_2d")
        return ("pose_keypoints_2d", "RHip"), ("pose_keypoints_2d", "LHip")
...
def pose_normalization_info(pose_header: PoseHeader):
    ...
    (c1, p1), (c2, p2) = pose_hips(pose_header)
